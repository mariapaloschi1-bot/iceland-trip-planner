export const itineraryData = [
  {
    ...
    image: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/20/20/f2/2e/fall-sunsets-are-divine.jpg?w=1200&h=800",
    activities: [
      {
  ...
  },
  {
    ...
    image: "https://elding.is/sites/default/files/2026-01/2026_01_27_1300_eldy_emily_131.jpg",
    activities: [
      {
  ...
  },
  {
    ...
    coordinates: [64.1466, -21.9426],
    image: "https://cdn.sanity.io/images/lf2d8f6r/production/05bf94aeefbda7be328798a68bf3fdd632ff6d60-2500x1662.jpg?q=75&fit=max&auto=format",
    activities: [
      {
...
export const experiencesDatabase = [
  ...
  },
  {
    ...
    category: "Wildlife",
    location: { lat: 64.1508, lng: -21.9395 },
    image: "https://gti.images.tshiftcdn.com/151608/x/0/il-pulcinella-di-mare-%C3%A8-considerato-da-molti-l'uccello-nazionale-dell'islanda?crop=1.91%3A1&fit=crop&width=1200",
    prices: [
  ...
  },
  {
    ...
    image: "https://cdn.sanity.io/images/lf2d8f6r/production/dc0bb0a159070d5168094a89c0b2b690dfe5d81b-2500x1698.jpg?q=75&fit=max&auto=format",
    prices: [
...
export const foodAndCulture = {
  food: [
    {
      ...
      emoji: "🥛",
      category: "Latticini",
      description: "Yogurt islandese ad alto contenuto proteico, simile allo yogurt greco ma più denso e cremoso. Tradizionalmente consumato a colazione con mirtilli e miele.",
      where: "Supermercati, café, ovunque",
      price: "€2-4",
      mustTry: true
    },
    {
      name: "Pylsur (Hot Dog Islandese)",
      emoji: "🌭",
      category: "Street Food",
      description: "Hot dog fatto con carne di agnello, maiale e manzo, servito con cipolla croccante, cipolla cruda, ketchup, senape dolce e remoulade. Il più famoso è da Bæjarins Beztu Pylsur a Reykjavík.",
      where: "Bæjarins Beztu Pylsur, chioschi",
      price: "€5-7",
      mustTry: true
    },
    {
      name: "Plokkfiskur",
      emoji: "🐟",
      category: "Piatti Tradizionali",
      description: "Stufato cremoso di pesce (solitamente merluzzo o eglefino) con patate, cipolle, besciamella e burro. Comfort food islandese per eccellenza.",
      where: "Ristoranti tradizionali",
      price: "€18-25",
      mustTry: true
    },
    {
      ...
      emoji: "🍲",
      category: "Piatti Tradizionali",
      description: "Zuppa di agnello con patate, carote, rape e cavolo. Piatto perfetto per scaldarsi dopo una giornata all'aperto.",
      where: "Ristoranti, café",
      price: "€12-18",
      mustTry: true
    },
    {
      ...
      emoji: "🐠",
      category: "Snack",
      description: "Pesce essiccato (solitamente eglefino) servito con burro. Snack tradizionale ricco di proteine, croccante e salato.",
      where: "Supermercati, negozi turistici",
      price: "€8-12",
      mustTry: false
    },
    {
      ...
      emoji: "🍩",
      category: "Dolci",
      description: "Ciambelle islandesi a forma di nodo, leggermente speziate con cardamomo. Perfette con il caffè.",
      where: "Panetterie, supermercati",
      price: "€2-3",
      mustTry: true
    },
    {
      ...
      emoji: "🍞",
      category: "Pane",
      description: "Pane di segale scuro e dolce, tradizionalmente cotto sottoterra usando il calore geotermico. Servito con burro salato e affettati.",
      where: "Panetterie, ristoranti",
      price: "€4-6",
      mustTry: true
    },
    {
      ...
      emoji: "🦈",
      category: "Estremi",
      description: "Squalo fermentato con odore pungente di ammoniaca. Piatto tradizionale vichingo per i più coraggiosi. Si accompagna con brennivín.",
      where: "Ristoranti tradizionali, mercati",
      price: "€8-15",
      mustTry: false,
      warning: "Odore e sapore molto forti!"
    },
    {
      name: "Svið",
      emoji: "🐑",
      category: "Estremi",
      description: "Testa di pecora bruciata e bollita, servita intera o a metà. Tradizionalmente mangiata in inverno.",
      where: "Ristoranti specializzati",
      price: "€15-25",
      mustTry: false,
      warning: "Solo per palati avventurosi"
    },
    {
      name: "Brennivín",
      emoji: "🍶",
      category: "Bevande",
      description: "Acquavite islandese aromatizzata al cumino, soprannominata 'morte nera'. Gradazione 37.5%, si beve fredda come shot.",
      where: "Vínbúðin (monopolio alcolici), bar",
      price: "€25-35 (bottiglia)",
      mustTry: true
    },
    {
      name: "Kaffi (Caffè Islandese)",
      emoji: "☕",
      category: "Bevande",
      description: "Gli islandesi sono tra i maggiori consumatori di caffè al mondo. Il caffè è forte, abbondante e spesso offerto gratuitamente con ricariche illimitate.",
      where: "Ovunque",
      price: "€3-5",
      mustTry: true
    },
    {
      name: "Öl (Birra Artigianale)",
      emoji: "🍺",
      category: "Bevande",
      description: "Birre artigianali islandesi eccellenti. Da provare: Einstök, Borg, Gull. La birra fu illegale in Islanda fino al 1989!",
      where: "Bar, ristoranti, Vínbúðin",
      price: "€8-12 (pinta)",
      mustTry: true
    }
  ],
  customs: [
    {
      emoji: "🚪",
      title: "Togliersi le scarpe in casa",
      description: "È consuetudine togliersi le scarpe quando si entra in una casa islandese. Molti hotel e guesthouse hanno aree apposite per le scarpe all'ingresso."
    },
    {
      emoji: "♨️",
      title: "Doccia OBBLIGATORIA prima delle piscine",
      description: "Doccia nuda senza costume è obbligatoria prima di entrare in piscine e lagune termali. Gli islandesi prendono l'igiene molto sul serio. Ci sono controlli!"
    },
    {
      emoji: "🏊",
      title: "La cultura delle piscine pubbliche",
      description: "Le piscine geotermiche sono il centro sociale islandese. Gli islandesi vanno in piscina per socializzare, rilassarsi e discutere di politica nelle vasche calde (hot pots)."
    },
    {
      emoji: "👻",
      title: "Credenza negli elfi (Huldufólk)",
      description: "Circa il 50% degli islandesi crede negli elfi o 'popolo nascosto'. Le strade vengono deviate per non disturbare rocce dove si ritiene vivano gli elfi."
    },
    {
      emoji: "📛",
      title: "Sistema dei nomi patronimici",
      description: "La maggior parte degli islandesi non ha cognome tradizionale. Il 'cognome' è formato dal nome del padre + -son/-dóttir. Es: Jón Stefánsson = Jón figlio di Stefán."
    },
    {
      emoji: "🎄",
      title: "I 13 Babbo Natale (Jólasveinar)",
      description: "L'Islanda ha 13 'Santa Claus' che visitano i bambini uno per notte nei 13 giorni prima di Natale. Ognuno ha una personalità dispettosa diversa."
    },
    {
      emoji: "🍻",
      title: "Il divieto della birra (fino al 1989)",
      description: "La birra fu illegale in Islanda dal 1915 al 1° marzo 1989. Ora il 1° marzo è celebrato come 'Bjórdagurinn' (Giorno della Birra)!"
    },
    {
      emoji: "📖",
      title: "Jólabókaflóð - L'alluvione di libri di Natale",
      description: "Tradizione natalizia islandese: regalare libri alla vigilia di Natale e passare la serata leggendo. L'Islanda pubblica più libri pro capite di qualsiasi altro paese."
    },
    {
      emoji: "🌬️",
      title: "Non esiste il cattivo tempo, solo vestiti sbagliati",
      description: "Detto islandese: 'Það er bara veður' (È solo tempo). Gli islandesi non cancellano mai piani per il meteo. Vestiti a strati e vai!"
    },
    {
      emoji: "🚗",
      title: "Lasciare il motore acceso",
      description: "D'inverno è comune lasciare l'auto accesa per ore per mantenerla calda. L'Islanda usa energia geotermica pulita, quindi inquinamento minimo."
    },
    {
      emoji: "🔞",
      title: "Monopolio degli alcolici",
      description: "Gli alcolici sopra il 2.25% possono essere venduti solo nei negozi statali 'Vínbúðin'. Orari limitati (generalmente 11-18, chiusi la domenica). Prezzi alti."
    },
    {
      emoji: "🎶",
      title: "Þrettándinn - Il tredicesimo giorno",
      description: "L'Epifania (6 gennaio) segna la fine del Natale. Gli islandesi celebrano con falò, fuochi d'artificio e il ritorno degli ultimi Jólasveinar."
    }
  ]
};
